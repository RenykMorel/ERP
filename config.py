...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = (
        ...
        or "mysql+mysqlconnector://root:@localhost/calculai_db"
    )
    ...
    CLAUDE_API_KEY = (
        ...
        or "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"
    )
